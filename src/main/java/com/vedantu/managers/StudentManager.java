...
public class StudentManager {
    ...
    // to hide warning since getLogger is a static method
    private final Logger logger = logFactory.getLogger(StudentManager.class);
    */
...
//		logger.info("adding to database after validation and checking for duplicates");
//		logger.info(stu.toString());
	...
	/* getById */
	public StudentModel getById(String id) throws Exception {
		if(id == null || id == "") {
